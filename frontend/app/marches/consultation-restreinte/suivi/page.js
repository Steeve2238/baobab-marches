...
export default function SuiviVentesPage() {
  ...
  return (
    <AppShell title={t("venteSuiviPageTitle")} subNav={<ConsultationRestreinteSousNav />}>
              ...
              {lignesFiltrees.map((l) => {
                ...
                return (
                  <tr key={l.devis_id} style={{ borderTop: "1px solid var(--line)" }}>
                    ...
                    <td style={tdStyle}>
                      <Link href={`/marches/consultation-restreinte/devis/${l.devis_id}`} className="mono" style={{ color: "var(--petrol)" }}>
                        {l.devis_numero}
                      </Link>
                      <div>
                    ...
                    <td style={tdStyle}>
                      {l.facture_id ? (
                        <>
                          <Link href={`/marches/consultation-restreinte/factures/${l.facture_id}`} className="mono" style={{ color: "var(--petrol)" }}>
