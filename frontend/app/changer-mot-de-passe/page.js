...
// Page de changement de mot de passe force : atteinte apres une premiere
// connexion avec un mot de passe temporaire genere par un admin (voir
// mustChangePassword renvoye par POST /auth/login). Volontairement hors
// d'AppShell, comme la page de login, pour rester accessible meme si
// l'utilisateur n'a pas encore explore le reste de l'application.
export default function ChangerMotDePassePage() {
  ...
  async function handleSubmit(e) {
    ...
    setChargement(true);
    try {
      await api.changerMotDePasse(nouveau);
