...
export default function LoginPage() {
  ...
  const { t, setLangue } = useLangue();
  const [email, setEmail] = useState("admin@baobabmarches.sn");
  ...
  return (
    <div
      style={{
        ...
        background:
          "linear-gradient(180deg, var(--petrol) 0%, #0A2E34 100%)",
      }}
    >
      <div className="card" style={{ width: 380, padding: 32, position: "relative" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 24 }}>
          <div
            style={{
              ...
              margin: "0 auto 12px",
              background:
                "conic-gradient(from 220deg, var(--ocre), #E8A354, var(--ocre))",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
          ...
          <h1 style={{ fontSize: 20, color: "var(--petrol)" }}>Baobab Marchés</h1>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {erreur && (
            <p style={{ color: "var(--brique)", fontSize: 12.5, marginTop: 10 }}>{erreur}</p>
          )}
