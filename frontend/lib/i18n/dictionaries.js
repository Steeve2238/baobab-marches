...
export const DICTIONARIES = {
  fr: {
    ...
    demandesRHPageSubtitle: "Congés, avances, ordres de mission, heures supplémentaires (étape 2/5 du Module 9 — RH).",
  ...
  en: {
    ...
    demandesRHPageSubtitle: "Leave, advances, mission orders, overtime (step 2/5 of Module 9 — HR).",
